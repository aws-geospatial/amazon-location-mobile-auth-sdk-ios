...
extension GeoRoutesClient {
    ...
    ///
    /// Use the CalculateIsolines action to find service areas that can be reached in a given threshold of time, distance, or the charge level available for the vehicle.
    ///
    ...
    ///
    /// Calculates a route with the required parameters: Origin and Destination.
    ///
