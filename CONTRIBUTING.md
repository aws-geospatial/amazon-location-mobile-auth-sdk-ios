...
Amazon Location Service Mobile Authentication SDK for iOS is released under the [Apache license][license]. Any code you submit will be released under that
